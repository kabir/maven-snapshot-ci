...
//        // If the artifacts are empty we get strange failures so write an file just to have something
//        String time = String.valueOf(System.currentTimeMillis());
//        Path timestampFile = input.resolve(time);
//        Files.createFile(timestampFile);
//        Files.write(timestampFile, time.getBytes(StandardCharsets.UTF_8));
